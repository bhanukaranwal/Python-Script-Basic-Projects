...
pygame.display.set_caption("Spectral Memory Resonator")
...
class Resonator:
    def __init__(self, memory):
        self.memory = memory
        self.base_freq = 220 + sum(ord(c) for c in memory) % 440
        self.phase = 0
        self.amplitude = 100
        self.time = 0
...
def main():
    ...
    resonator = None
    input_active = True
    info_text = "Type a memory and press Enter to hear its resonance."
    ...
    while True:
        ...
        input_surface = FONT.render("Enter a memory: " + input_text, True, WHITE)
